...
interface TooltipArrowProps extends ComponentProps<typeof Arrow> {
    width?: string;
    height?: string;
}
declare function TooltipArrow({ width, height, ...props }: TooltipArrowProps): JSX.Element;
...
declare function Tooltip({ children, delayDuration, ...props }: TooltipProps): JSX.Element;
...
declare function Toast({ children }: ToastProps): JSX.Element;
declare const ToastWrapper: ({ children, ...props }: ToastProps) => JSX.Element;
declare const ToastTitle: _stitches_react_types_styled_component.StyledComponent<_stitches_react_types_styled_component.StyledComponent<"h2", {
    size?: "sm" | "md" | "lg" | "2xl" | "4xl" | "5xl" | "6xl" | "3xl" | undefined;
}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: unknown;
    fontSizes: unknown;
...
declare const ToastDescription: _stitches_react_types_styled_component.StyledComponent<_stitches_react_types_styled_component.StyledComponent<"p", {
    size?: "xxs" | "xs" | "sm" | "md" | "lg" | "xl" | "2xl" | "4xl" | "5xl" | "6xl" | "7xl" | "8xl" | "9xl" | undefined;
}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: unknown;
    fontSizes: unknown;
...
declare const StyledModalWrapper: _stitches_react_types_styled_component.StyledComponent<react.ForwardRefExoticComponent<DialogPrimitive.DialogContentProps & react.RefAttributes<HTMLDivElement>>, {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: unknown;
    fontSizes: unknown;
    fontWeights: unknown;
    fonts: unknown;
...
declare function Modal({ children, overlay, ...props }: ModalProps): JSX.Element;
declare type ModalWrapperProps = DialogPrimitive.DialogContentProps & ComponentProps<typeof StyledModalWrapper> & {
    width?: number;
    maintainDimensions?: boolean;
};
declare const ModalWrapper: ({ children, width, maintainDimensions, ...props }: ModalWrapperProps) => JSX.Element;
...
export { Avatar, AvatarProps, Box, BoxProps, Button, ButtonProps, Checkbox, CheckboxProps, Heading, HeadingProps, Modal, ModalContent, ModalProps, ModalTrigger, ModalWrapper, ModalWrapperProps, MultiStep, MultiStepProps, Text, TextArea, TextAreaProps, TextInput, TextInputProps, TextProps, Toast, ToastDescription, ToastProps, ToastTitle, ToastWrapper, Tooltip, TooltipArrow, TooltipArrowProps, TooltipContent, TooltipProps, TooltipTrigger };
